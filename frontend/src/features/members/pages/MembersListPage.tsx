  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-1000 pb-10">
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8 sm:mb-12">
        <div>
          <h2 className="text-[10px] sm:text-sm font-sans font-bold text-primary uppercase tracking-[0.4em] mb-2 sm:mb-3">Administración</h2>
      ...
      <div className="flex flex-col lg:flex-row lg:items-center gap-4 sm:gap-6 mb-8">
        <div className="flex items-center gap-2 bg-surface-low p-1.5 rounded-2xl w-full sm:w-fit border border-white/[0.03] overflow-x-auto no-scrollbar">
          <Button 
            ...
            className={`flex-1 sm:flex-none px-4 sm:px-6 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all whitespace-nowrap ${!activeTab ? '' : 'text-text-secondary hover:text-text-main'}`}
          >
            Todos
          </Button>
          <Button 
            ...
            className={`flex-1 sm:flex-none px-4 sm:px-6 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all whitespace-nowrap ${activeTab === 'ACTIVE' ? '' : 'text-text-secondary hover:text-text-main'}`}
          >
            Activos
          </Button>
          <Button 
            ...
            className={`flex-1 sm:flex-none px-4 sm:px-6 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all whitespace-nowrap ${activeTab === 'INACTIVE' ? '' : 'text-text-secondary hover:text-text-main'}`}
          >
            Inactivos
          </Button>
        </div>
