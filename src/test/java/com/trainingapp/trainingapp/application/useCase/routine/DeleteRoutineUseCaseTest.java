...
class DeleteRoutineUseCaseTest {
    ...
    @InjectMocks private DeleteRoutineUseCase useCase;

    @Test
    @DisplayName("Debería marcar una rutina como borrada")
    void shouldDeleteRoutineSuccessfully() {
        ...
        verify(mockRoutine).validateForDeletion();
        verify(mockRoutine).deactivate();
